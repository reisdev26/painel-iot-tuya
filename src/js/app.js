 ...
 *  Ano: 2026
 *  Descrição:
 *  Dashboard de monitoramento IoT com:
 *  - Integração Tuya Cloud
 *  - Indicador sistêmico
...
let previousTemperature = null; // 🌡 controla tendência
...
async function fetchData() {
  try {
    ...
    // ✅ AQUI entra o indicador verde
    document.getElementById("system-indicator").textContent = "🟢";
    document.getElementById("update-text").textContent =
      "Sistema operacional • " + formatTimeAgo(lastUpdateTime);
    ...
    // ✅ AQUI entra o indicador vermelho
    document.getElementById("system-indicator").textContent = "🔴";
    document.getElementById("update-text").textContent =
...
function getTemperatureTrend(currentTemp) {
  ...
  let trend = { symbol: "➖", className: "trend-neutral" };

  if (currentTemp > previousTemperature) {
    trend = { symbol: "▲", className: "trend-up" };
  } else if (currentTemp < previousTemperature) {
    trend = { symbol: "▼", className: "trend-down" };
  }
...
console.log("Desenvolvido por Welerson Reis • 2026");
